...
namespace CattleystData.Data
{
    ...
    public class DataTableColumnAttribute : Attribute
    {
        ...
        public DataTableColumnAttribute(int[] colIndex, string colName = "", bool searchable = true, bool orderable = true, 
            string colType = null, string width = null, string className = null, string defaultContent = "")
        {
            ColIndexs = colIndex;
            ColName = colName;
        ...
        public DataTableColumnAttribute(int colIndex, string colName = null, bool searchable = true, bool orderable = true, 
            string colType = null, string width = null, string className = null, string defaultContent = "")
            : this(new int[] { colIndex }, colName, searchable, orderable, colType, width, className, defaultContent)
        {
        }
    }
}
